/**
 * import-articles-batch2.mjs
 *
 * Imports 10 US-5.4 Batch 2 articles from docs/US-5.4-batch2/articles/
 * into Sanity CMS (project: 1rkr5mdi, dataset: production).
 *
 * Usage:
 *   node scripts/import-articles-batch2.mjs            # import
 *   node scripts/import-articles-batch2.mjs --dry-run  # log only, no writes
 *   node scripts/import-articles-batch2.mjs --backup   # backup existing articles first
 */
...
const ARTICLES_DIR = path.join(process.cwd(), 'docs', 'US-5.4-batch2', 'articles')
...
async function importArticles() {
  ...
  console.log(`Found ${files.length} article file(s) in docs/US-5.4-batch2/articles/\n`)
