    ...
    >
      <div className="flex flex-col items-center gap-6 md:flex-row md:items-start">
        <Image
          ...
          alt="John Arthur, founder of Maple Insight"
          width={200}
          height={200}
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-sm text-gray-500">Founder, Maple Insight</p>
          ...
          <p className="mt-3 max-w-2xl leading-relaxed text-gray-600">
            ...
            journey — from navigating the immigration process to filing my first Canadian tax
            return — I built Maple Insight to help newcomers integrate into Canadian life and make
            smarter financial decisions from day one.
          </p>

          <Link
            href="/about"
            className="mt-4 inline-block text-sm font-medium text-gray-900 underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:rounded"
          >
            Read my full story →
          </Link>
        </div>
