...
type Props = {
  ...
  /** 'top' renders above article content; 'bottom' renders below */
  position?: 'top' | 'bottom';
}

export function ReviewedByBadge({ contributor, reviewDate, position = 'top' }: Props) {
    ...
    >
      ...
      {contributor.photoUrl ? (
        ...
        <div style={{
          ...
          color: C.white, fontFamily: serif, fontSize: 11,
